<x-layouts.app :title="isset($category) ? 'Edytuj kategorię pomysłów' : 'Nowa kategoria pomysłów'">
    <div class="max-w-lg">
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            <form action="{{ isset($category) ? route('idea-categories.update', $category) : route('idea-categories.store') }}" method="POST">
                @csrf
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Ikona (emoji)</label>
                ...
                <div class="flex items-center gap-3 mt-6">
                    ...
                    <a href="{{ route('idea-categories.index') }}" class="px-5 py-2 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-200 transition-colors">Anuluj</a>
                </div>
            </form>
        </div>
    </div>
